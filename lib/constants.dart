...
const myprojectsinfocolor=Color(0xFFd6ce93);
const darkColor = Color(0xFF191923);
const bodyTextColor = Color(0xFF8B8B8D);
const bgColor = Color(0xFF1E1E28);
const recommenbackcolor=Color(0xFFffddd2);
const myprojectscardcolor=Color(0xff335c67);
// const profilcolor=Color(0xff1b4332);
const profilcolor2=Color(0xff7c9885);
//paddings
